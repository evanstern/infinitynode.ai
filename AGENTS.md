...
5. **If the working directory contains an `AGENTS.md`**, read it — it provides project-specific context layered on top of this global config. Do this automatically without being asked.
